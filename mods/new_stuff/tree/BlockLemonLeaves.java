...
{
    public static final String[] LemonLEAF_TYPES = new String[] {"Lemon"};
    int[] adjacentTreeBlocks;
    private Icon[][] iconArray = new Icon[2][];
	private int field_94394_cP;
	public static final String[] LemonwoodType = new String[] {"Lemon"};
	 public static final String[][] field_94396_b = new String[][] {{"LemonLeaves"}, {"LemonLeavesOpaque"}};

	
    public BlockLemonLeaves(int par1)
    {
    ...
    {
        return New_Stuff.LemonSapling.blockID;
    }
    ...
    public void dropBlockAsItemWithChance(World par1World, int par2, int par3, int par4, int par5, float par6, int par7)
    {
        if (!par1World.isRemote)
        {
            ...
            {
                this.dropBlockAsItem_do(par1World, par2, par3, par4, new ItemStack(New_Stuff.Lemon, 1, 0));
            }
        }
    }
	...
	public void registerIcons(IconRegister reg){
		this.blockIcon = reg.registerIcon("new_stuff:LemonLeaves");
	}
