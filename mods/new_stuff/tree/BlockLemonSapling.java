...
{
    public static final String[] LemonWOOD_TYPES = new String[] {"Lemon"};
    @SideOnly(Side.CLIENT)
    private Icon[] saplingIcon;

    public BlockLemonSapling(int par1)
    {
        super(par1);
        float f = 0.4F;
    ...
    public void growTree(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        else if (l == 3)
        {
            ...
            if (object == null)
            {
                j1 = 0;
                i1 = 0;
                object = new WorldGenLemonTrees(true, 4 + par5Random.nextInt(7), 3, 3, false);
            }
        }
        else
        {
            object = new WorldGenLemonTrees(true);
    ...
    @Override
   	public void registerIcons(IconRegister reg){
   		this.blockIcon = reg.registerIcon("new_stuff:LemonSapling");
   	}}