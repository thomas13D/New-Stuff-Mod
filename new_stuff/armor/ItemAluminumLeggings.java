...
public class ItemAluminumLeggings extends ItemArmor{
public ItemAluminumLeggings(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4){
...
public void registerIcons(IconRegister reg){
	this.itemIcon = reg.registerIcon("new_stuff:AluminumLeggings");
}
